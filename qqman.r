...
print("Generating manhatton plot of PLINK GWAS SNPs.")
# read in gwas results
gwas <- read.table('gwas_linreg.assoc.linear',header=T)

# create manhattan plot
png(filename='manhattan_plot.png')
manhattan(gwas,
          main = 'Manhattan Plot of PLINK GWAS P-values')
dev.off()
print("manhattan_plot.png has been saved.")
